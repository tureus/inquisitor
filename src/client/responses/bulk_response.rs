...
use super::common::{DefaultAllocatedField, Shards};
use super::parsing::{HttpResponseHead, IsOk, MaybeOkResponse, ResponseBody, Unbuffered};
use super::error::*;
        ...
        TId: Deserialize<'de>,
{
            ...
            D: Deserializer<'de>,
    {
        ...
        deserializer.deserialize_any(ItemDeVisitor {
            _marker: PhantomData,
        })
    }
}
        ...
        TId: Deserialize<'de>,
{
    ...
    deserializer.deserialize_any(OkItemsVisitor {
        _marker: PhantomData,
    })
}
